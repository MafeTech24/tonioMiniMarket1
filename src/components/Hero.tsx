  ...
  <section id="inicio" className="bg-background">
    <div className="container mx-auto grid md:grid-cols-2 items-center gap-8 py-12 md:py-20 px-4">
      ...
      <div className="order-2 md:order-1 flex flex-col items-center text-center">
        <h1 className="font-heading text-5xl md:text-7xl lg:text-8xl font-extrabold text-primary tracking-tight flex flex-col items-center gap-4 md:gap-6 lg:gap-8">
          <span>DESPENSA Y</span>
          <span>POLLERÍA</span>
        </h1>
        <h2 className="mt-8 font-heading text-2xl md:text-3xl lg:text-4xl text-foreground font-bold tracking-tight">
          Calidad, frescura y los mejores precios
        </h2>
        <h3 className="mt-4 font-body text-base md:text-lg text-secondary/90 font-medium max-w-lg leading-relaxed">
